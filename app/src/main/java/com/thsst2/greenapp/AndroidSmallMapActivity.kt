...
class AndroidSmallMapActivity : AppCompatActivity(), OnMapReadyCallback {
	...
	private fun setupMarkerClickListener() {
		mMap.setOnMarkerClickListener { marker ->
			showFloorSelectionDialog(marker.title ?: "Unknown Building")
			true
		}
	}

	private fun showFloorSelectionDialog(buildingName: String) {
		val buildingFloors = mapOf(
			"Henry Sy Sr. Hall" to arrayOf("Ground Floor", "2nd Floor", "3rd Floor", "4th Floor", "5th Floor", "6th Floor", "7th Floor", "8th Floor"),
			"Velasco Hall" to arrayOf("Ground Floor", "2nd Floor", "3rd Floor", "4th Floor", "5th Floor"),
			"St. La Salle Hall" to arrayOf("Ground Floor", "2nd Floor", "3rd Floor"),
		)

		val floors = buildingFloors[buildingName] ?: buildingFloors["Default"]!!

		AlertDialog.Builder(this)
			.setTitle("Select Floor - $buildingName")
			.setItems(floors) { _, which ->
				val selectedFloor = floors[which]
				Toast.makeText(
					this,
					"You selected $selectedFloor at $buildingName",
					Toast.LENGTH_SHORT
				).show()
			}
