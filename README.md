...
# Names and contact details of the proponents and adviser:
```
Ong, Ethel (ethel.ong@dlsu.edu.ph)
Lim, Sean Higgins K. (seanhigginslim@gmail.com / 09178949838)
...
G.R.E.E.N. is a virtual tour companion that creates a dynamic tour based on the user's preferences. Using the institution's information as its knowledgebase, it also serves as
...
# Overview of the deliverables’ file structure (and if you have additional files from the standard requirements)
```
```
